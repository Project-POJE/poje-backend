package com.portfolio.poje.domain.portfolio.service.serviceImpl;
...
public class PortfolioServiceImpl implements PortfolioService {
    ...
    @Override
    @Transactional
    public PfDto.PfInfoResp updatePortfolioInfo(Long portfolioId, PfDto.PfUpdateReq pfUpdateReq, MultipartFile file) throws IOException {
        Member member = memberRepository.findByLoginId(SecurityUtil.getCurrentMemberId()).orElseThrow(
                () -> new PojeException(ErrorCode.MEMBER_NOT_FOUND)
        );
